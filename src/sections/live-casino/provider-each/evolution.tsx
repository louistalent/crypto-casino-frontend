...
const img1 = `${ASSETS_API}/live-casino/provider-each/evolution/1.png`;
const img2 = `${ASSETS_API}/live-casino/provider-each/evolution/2.png`;
const img3 = `${ASSETS_API}/live-casino/provider-each/evolution/3.png`;
const img4 = `${ASSETS_API}/live-casino/provider-each/evolution/4.png`;
const img5 = `${ASSETS_API}/live-casino/provider-each/evolution/5.png`;
const img6 = `${ASSETS_API}/live-casino/provider-each/evolution/6.png`;
const img7 = `${ASSETS_API}/live-casino/provider-each/evolution/7.png`;
const img8 = `${ASSETS_API}/live-casino/provider-each/evolution/8.png`;
const big_img1 = `${ASSETS_API}/live-casino/provider-each/evolution/big_1.png`;
const big_img2 = `${ASSETS_API}/live-casino/provider-each/evolution/big_2.png`;
...
const HomeGallery = () => {
    ...
    const openGamePlay = async () => {
        const rows: any = providerGameList.filter((obj: any) => obj.provider.name === 'evolution-live');
        playgame(rows[0].gameid, 'evolution-live', rows[0].sevice);
    };

    const onchangeprovider = () => {
        providerGame('evolution-live');
        navigate(`/live-casino/evolution-live`);
    };
