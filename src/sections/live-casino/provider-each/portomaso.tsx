...
const img1 = `${ASSETS_API}/live-casino/provider-each/portomaso/1.png`;
const img2 = `${ASSETS_API}/live-casino/provider-each/portomaso/2.png`;
const img3 = `${ASSETS_API}/live-casino/provider-each/portomaso/3.png`;
const img4 = `${ASSETS_API}/live-casino/provider-each/portomaso/4.png`;
const img5 = `${ASSETS_API}/live-casino/provider-each/portomaso/5.png`;
const img6 = `${ASSETS_API}/live-casino/provider-each/portomaso/6.png`;
const img7 = `${ASSETS_API}/live-casino/provider-each/portomaso/7.png`;
const img8 = `${ASSETS_API}/live-casino/provider-each/portomaso/8.png`;
...
const HomeLive = () => {
    ...
    const openGamePlay = async () => {
        const rows: any = providerGameList.filter((obj: any) => obj.provider.name === 'Portomaso');
        playgame(rows[0].gameid, 'Portomaso', rows[0].sevice);
    };

    const onchangeprovider = () => {
        providerGame('Portomaso');
        navigate(`/live-casino/Portomaso`);
    };
