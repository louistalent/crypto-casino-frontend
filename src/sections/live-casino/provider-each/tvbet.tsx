...
const img1 = `${ASSETS_API}/live-casino/provider-each/tvbet/1.png`;
const img2 = `${ASSETS_API}/live-casino/provider-each/tvbet/2.png`;
const img3 = `${ASSETS_API}/live-casino/provider-each/tvbet/3.png`;
const img4 = `${ASSETS_API}/live-casino/provider-each/tvbet/4.png`;
const img5 = `${ASSETS_API}/live-casino/provider-each/tvbet/5.png`;
const img6 = `${ASSETS_API}/live-casino/provider-each/tvbet/6.png`;
const img7 = `${ASSETS_API}/live-casino/provider-each/tvbet/7.png`;
const img8 = `${ASSETS_API}/live-casino/provider-each/tvbet/8.png`;
...
const HomeLive = () => {
    ...
    const openGamePlay = async () => {
        const rows: any = providerGameList.filter((obj: any) => obj.provider.name === 'TVBet');
        playgame(rows[0].gameid, 'TVBet', rows[0].sevice);
    };

    const onchangeprovider = () => {
        providerGame('TVBet');
        navigate(`/live-casino/TVBet`);
    };
