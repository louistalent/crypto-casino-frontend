...
const img1 = `${ASSETS_API}/live-casino/provider-each/vivo/1.png`;
const img2 = `${ASSETS_API}/live-casino/provider-each/vivo/2.png`;
const img3 = `${ASSETS_API}/live-casino/provider-each/vivo/3.png`;
const img4 = `${ASSETS_API}/live-casino/provider-each/vivo/4.png`;
const img5 = `${ASSETS_API}/live-casino/provider-each/vivo/5.png`;
const img6 = `${ASSETS_API}/live-casino/provider-each/vivo/6.png`;
const img7 = `${ASSETS_API}/live-casino/provider-each/vivo/7.png`;
const img8 = `${ASSETS_API}/live-casino/provider-each/vivo/8.png`;
...
const HomeLive = () => {
    ...
    const openGamePlay = async () => {
        const rows: any = providerGameList.filter((obj: any) => obj.provider.name === 'VivoLive');
        playgame(rows[0].gameid, 'VivoLive', rows[0].sevice);
    };

    const onchangeprovider = () => {
        providerGame('VivoLive');
        navigate(`/live-casino/VivoLive`);
    };
